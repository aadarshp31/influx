			...
			<div className='mx-auto flex max-w-7xl items-center justify-between px-4 py-2'>
				<Link to='/'>
					<div className='inline-flex items-center space-x-2'>
						...
						<span className='font-bold'>Influx</span>
					</div>
				</Link>
							...
							<div className='px-5 pb-6 pt-5'>
								...
								{!AuthUtils.isLoggedIn() ? (
									<Link to='/auth'>
										<Button
											variant='outline'
											className='rounded-md bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/80 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black mt-2 ml-2'
										>
											Login
										</Button>
									</Link>
